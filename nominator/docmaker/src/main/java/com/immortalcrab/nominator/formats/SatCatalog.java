        ...
        switch (field) {
            ...
            case "tipo_percepcion":
                m = ImmutableMap.<String, String>builder()
                    ...
                    .put("050", "Viáticos")
                    .put("051", "Pagos por gratificaciones, primas, compensaciones, recompensas u otros a extrabajadores derivados de jubilación en parcialidades")
                    .put("052", "Pagos que se realicen a extrabajadores que obtengan una jubilación en parcialidades derivados de la ejecución de resoluciones judicial o de un laudo")
                    .put("053", "Pagos que se realicen a extrabajadores que obtengan una jubilación en una sola exhibición derivados de la ejecución de resoluciones judicial o de un laudo")
                    .build();
                break;
            ...
            case "tipo_deduccion":
                m = ImmutableMap.<String, String>builder()
                    ...
                    .put("018", "Cuotas para la constitución y fomento de sociedades cooperativas y de cajas de ahorro")
                    ...
                    .put("065", "Ajuste en Jubilaciones, pensiones o haberes de retiro en una sola exhibición Exento ")
                    .put("066", "Ajuste en Jubilaciones, pensiones o haberes de retiro en una sola exhibición Gravado")
                    ...
                    .put("079", "Ajuste en Pagos distintos a los listados y que no deben considerarse como ingreso por sueldos, salarios o ingresos asimilados.")
                    ...
                    .put("102", "Ajuste a pagos por gratificaciones, primas, compensaciones, recompensas u otros a extrabajadores derivados de jubilación en parcialidades, gravados")
                    .put("103", "Ajuste a pagos que se realicen a extrabajadores que obtengan una jubilación en parcialidades derivados de la ejecución de una resolución judicial o de un laudo gravados")
                    .put("104", "Ajuste a pagos que se realicen a extrabajadores que obtengan una jubilación en parcialidades derivados de la ejecución de una resolución judicial o de un laudo exentos")
                    .put("105", "Ajuste a pagos que se realicen a extrabajadores que obtengan una jubilación en una sola exhibición derivados de la ejecución de una resolución judicial o de un laudo gravados")
                    .put("106", "Ajuste a pagos que se realicen a extrabajadores que obtengan una jubilación en una sola exhibición derivados de la ejecución de una resolución judicial o de un laudo exentos")
            ...
            case "tipo_otro_pago":
                m = ImmutableMap.<String, String>builder()
                    ...
                    .put("005", "Reintegro de ISR retenido en exceso de ejercicio anterior (siempre que no haya sido enterado al SAT).")
                    .put("006", "Alimentos en bienes (Servicios de comedor y comida) Art 94 último párrafo LISR.")
                    .put("007", "ISR ajustado por subsidio.")
                    .put("008", "Subsidio efectivamente entregado que no correspondía (Aplica sólo cuando haya ajuste al cierre de mes en relación con el Apéndice 7 de la guía de llenado de nómina).")
                    .put("009", "Reembolso de descuentos efectuados para el crédito de vivienda.")
                    .put("999", "Pagos distintos a los listados y que no deben considerarse como ingreso por sueldos, salarios o ingresos asimilados.")
                    .build();
                break;
